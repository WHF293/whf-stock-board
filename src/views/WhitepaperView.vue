    ...
    blocks: [
      {
        ...
        items: [
          {
            term: '左侧导航',
            desc: '全站页面入口（市场总览、市场榜单、行情全景、板块日历、市场异动、自选股、选股器、热点新闻、账户管理）。底部是「设置」入口，点开为右侧抽屉。插件也会往这里加页面（「插件工坊」「股票主线」就是插件贡献的，见「插件体系与开放接口」章节）。',
          },
          {
            term: '顶栏',
      ...
      },
      {
        ...
        items: [
          ...
          '侧栏顺序可自定义：设置 →「侧栏导航 → 路由顺序编排」拖拽排序，确认后立即生效并记住，也可一键重置。',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          {
            term: '成交额与资金速览',
            desc: '展示两市成交额与主力净流入，并给出近 30 / 60 / 180 日成交额走势（总成交额、上证、深证三条线）。表格列有日期、总成交额、较上日、上证、深证，可点表头排序，也可切换到列表逐日核对。',
          },
          {
            term: '涨跌分布',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          {
            term: '板块主力 / 个股主力 / 北向持股',
            desc: '资金流三榜，各取前 15。板块主力行可展开成分股表格，继续查看板块内部结构。',
          },
          {
            term: '页签配置',
      ...
      },
      {
        ...
        items: [
          ...
          '「板块主力净流入 + 板块上涨」同向说明有真金白银介入；「涨幅高但主力净流出」则有拉高派发嫌疑。',
          '板块主力行展开成分股，可确认上涨是否由少数龙头撑起（龙头拉、多数绿 = 内部不齐心）。',
        ],
      },
      {
        type: 'tip',
        text: '行情类榜单在交易时段每 30 秒刷新一次；资金流类为重接口，进入页签只拉一次。表头排序只作用于已加载的前 100 / 15 条数据，不等价于全市场排序。',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            desc: '「查看赚钱效应」打开气泡图，气泡面积正比于得分率绝对值，右半区为赚钱效应方向；「恢复热门排序」仅在自定义过行序后出现；「刷新」在采集进行中或浏览器开发模式下不可用。',
          },
        ],
      },
      {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          [
            '股票主线',
            '左侧导航「股票主线」页面：用行业板块成交占比分位、量能倍数、价格分位做抱团主线四阶段判定（萌芽 / 确认 / 狂热 / 瓦解），只给阶段标签与风险提示，不含买卖指令；扫描结果落本机库，重进页面不重新联网。',
          ],
          [
            '插件工坊',
    ...
    blocks: [
      {
        ...
        items: [
          ...
          {
            term: '主题色',
            desc: '清新绿 / 淡雅蓝 / 淡雅粉 / 极光紫，即时生效并记住选择，暗色模式自动适配。',
          },
          {
            term: '涨跌颜色',
          ...
          {
            term: '侧栏导航',
            desc: '「路由顺序编排」拖拽调整左侧导航顺序，确认后立即刷新侧栏；「重置」恢复默认顺序。',
          },
          {
            term: '系统日志',
          ...
          {
            term: '系统',
            desc: '作者与 GitHub 仓库入口、当前版本号与「检查更新」（对比 GitHub Releases 最新版本，发现新版会给出下载入口）。',
          },
        ],
      },
      {
