...
import { MAINLINE_INDUSTRY_ALIAS, MAINLINE_LIMIT_UP_POOL_TYPE } from './constants';
import type { ZTPoolItem } from '../../types/event.types';
import type { LimitUpAggregate, LimitUpStat, ThsBoardRef } from './types';
 ...
 */
export const fetchLimitUpPool = async (date: string): Promise<ZTPoolItem[]> =>
  fetchZtPool(MAINLINE_LIMIT_UP_POOL_TYPE, date);
