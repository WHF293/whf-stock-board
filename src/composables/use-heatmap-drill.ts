 ...
 * @returns drillView 下钻视图状态；isDrillLoading 拉取中；drillError 失败板块名；drillInto 下钻；backToBoards 返回板块层
 */
export const useHeatmapDrill = () => {
  ...
  return { drillView, isDrillLoading, drillError, drillInto, backToBoards };
};
