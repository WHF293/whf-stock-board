...
const ICON_PATHS: Record<string, string> = {
  ...
  // 导入（粘贴）：剪贴板 + 向下箭头
  clipboardPaste:
    '<rect x="8" y="3" width="8" height="4" rx="1"/><path d="M16 5h2a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2"/><path d="M12 11v6"/><path d="M9.5 14.5 12 17l2.5-2.5"/>',
};
